<template lang="pug">
  div.current_level-wrapper
    ...
    .current_level__content
      .current_level__content-top
        ...
        .current_level-data
          .question__title-wrapper
            label(for="question__title").question__label.question__title Текс вопроса
          .question__input-wrapper
            input(type="text"  v-model="currentQuestion").question__input
          .current_level__question-wrap
            label.current_level__question-label(for="question__type") Тип вопроса
          .current_level__question-wrap
      ...
      .current_level__topic-wrap
        h1.current_level__topic.current_level__topic_question(v-if="typeOfQuestion!='handwritingAnswer'") Добавление ответов
        h1.current_level__topic.current_level__topic_question(v-else) Добавление ключевых слов
