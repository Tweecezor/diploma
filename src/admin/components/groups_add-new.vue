...
.group__content.content
  ...
  .group__form
    ...
    .group__info.group__info--student
      h2.group__title.tittle.group__title--student Студенты
    ...
    .group__label-wrap.group__label-addGroup.student__add
      myIcon.student__add_icon(iconName="plus")
      button.btn.group__submit.student__add_button(
        type="submit",
        name="submit",
        value="Сохранить",
        @click="addStudent"
