...
.wrapper-
    ...
    .answer_new
      .answer_new__data
        ...
        .answer_new__input-wrap
          ...
          .answer_new__actions(@click="addAnswer")
            myIcon(iconName="add" )
            //- button.answer_new__btn.answer_new__btn(@click="addAnswer") Добавить ответ
    .answers__title-wrap(v-if="answers.length")
      h2.answer__title Список ответов
    .answers__wrapper
  ...
  .actions__button-wrap
    button.actions__button-end.btn(@click="endWorkWithQUestion") Завершить
